...
if(isset($_POST['submitted'])) {
	...
	if(trim($_POST['checking']) !== '') {
		...
		if(trim($_POST['contactName']) === '') {
			$nameError =  __('Please enter your name.', 'woothemes'); 
			$hasError = true;
		} else {
		...
		if(trim($_POST['email']) === '')  {
			$emailError = __('Please enter a valid email address where we can respond to you.', 'woothemes');
			$hasError = true;
		...
		if(trim($_POST['comments']) === '') {
			$commentError = __('Please enter a message.', 'woothemes');
			$hasError = true;
		} else {
	...
	jQuery('form#contactForm').submit(function() {
		...
		jQuery('.requiredField').each(function() {
			if(jQuery.trim(jQuery(this).val()) == '') {
				...
				jQuery(this).parent().append('<span class="error"><?php _e('Please enter your', 'woothemes'); ?> '+labelText+'.</span>');
		...
		if(!hasError) {
			...
			jQuery.post(jQuery(this).attr('action'),formInput, function(data){
				jQuery('form#contactForm').slideUp("fast", function() {				   
					jQuery(this).before('<p class="tick"><?php _e('<strong>Thanks!</strong> Your message has been sent to us.  We always do our best to respond in a timely manner.', 'woothemes'); ?></p>');
				});
			});
		}
                ...
                <?php while (have_posts()) : the_post(); ?>
                    ...
                    <form action="<?php the_permalink(); ?>" id="contactForm" method="post">
                        ...
                        <ol class="forms">
                            ...
                            <li class="textarea"><label for="comments"><?php _e('Message', 'woothemes'); ?></label>
