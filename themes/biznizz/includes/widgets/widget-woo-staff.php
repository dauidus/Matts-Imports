		...
		foreach( $authors as $author ) { ?>
			...
			<li>
        		...
        		<span class="details">
        			...
        			<span class="description"><?php if ( $pageid > 0 ) { ?><a href="<?php echo get_permalink( $pageid ).'#'.$author->ID; ?>" style="float:left;" title="<?php the_author_meta( 'user_firstname', $author->ID ); ?> <?php the_author_meta( 'user_lastname', $author->ID ); ?>"><?php } ?><?php echo get_avatar( $author->ID, '60' ); ?><?php if ( $pageid > 0 ) { ?></a><?php } ?><?php the_author_meta( 'description', $author->ID ); ?></span>
        		</span>
